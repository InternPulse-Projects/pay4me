...
function FooterNav() {
  return (
    <section className="w-full flex flex-col justify-center px-30 py-10 sm:px-25 space-y-4 max-sm:px-10 items-center">
      <div className="flex lg:flex-row md:flex-row max-sm:flex-col sm:flex-col sm:space-y-4 max-sm:space-y-4 border-0">
        <div className="w-80 flex flex-col space-y-4 border-0">
        ...
        <div className="grid grid-cols-3 space-x-30 max-sm:grid max-sm:grid-cols-2 max-sm:space-y-4 border-0">
        ...
        <div className="w-96 flex flex-col space-y-4 border-0">
          <DownloadBlack />
